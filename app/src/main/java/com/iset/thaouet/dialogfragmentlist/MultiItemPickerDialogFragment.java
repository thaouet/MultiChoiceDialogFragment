...
public class MultiItemPickerDialogFragment extends DialogFragment {
    public static final String LOGTAG = "th.MultiItemPicker";
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(MultiItemPickerDialogFragment fragment, Item item, int index);
    }
     ...
     */
    public static MultiItemPickerDialogFragment newInstance(String title, ArrayList<Item> items, int selectedIndex) {
        Bundle args = new Bundle();
        args.putString(ARG_TITLE, title);
        args.putBundle(ARG_ITEMS, Item.bundleOfItems(items));
        args.putInt(ARG_SELECTED_INDEX, selectedIndex);

        MultiItemPickerDialogFragment fragment = new MultiItemPickerDialogFragment();
     ...
     * Constructor
     */
    public MultiItemPickerDialogFragment() {
    }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (activity instanceof OnItemSelectedListener) {
                            if (0 <= selectedIndex && selectedIndex < items.size()) {
                                ...
                                listener.onItemSelected(MultiItemPickerDialogFragment.this, item, selectedIndex);
                            }
                        }
                    }
                })
